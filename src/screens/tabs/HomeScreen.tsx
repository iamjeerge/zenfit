/**
 * @file HomeScreen.tsx
 * @module screens/tabs/HomeScreen
 * @description Home dashboard tab — the app's landing screen after login.
 * Shows the daily mantra, AI briefing, quick action buttons, and streak stats.
 */
