/**
 * @file BreatheScreen.tsx
 * @module screens/tabs/BreatheScreen
 * @description Guided breathing tab — offers multiple breathing techniques
 * (4-7-8, Box, Diaphragmatic, Coherence) with animated circle guidance
 * and cycle / elapsed-time statistics.
 */
