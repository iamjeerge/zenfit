 ...
 * @description Authentication screen — handles both Sign In and Sign Up flows.
 * Validates inputs locally before calling Supabase Auth.
 * On success, navigates to the onboarding flow (new users) or the main tabs.
 */
