...
export const Gradients = {
  // ── Aurora Gradients ─────────────────────────
  aurora: ['#7C3AED', '#C4B5FD', '#F472B6'] as string[],
  auroraSubtle: ['#7C3AED', '#A78BFA'] as string[],
  cosmic: ['#0D0B1A', '#1A1730', '#2D2554'] as string[],
  sunrise: ['#F472B6', '#FBBF24', '#FB923C'] as string[],
  ocean: ['#60A5FA', '#7C3AED'] as string[],
  forest: ['#34D399', '#059669'] as string[],
  lotus: ['#F472B6', '#C4B5FD', '#7C3AED'] as string[],

  // ── Card Gradients ───────────────────────────
  cardPrimary: ['rgba(124, 58, 237, 0.3)', 'rgba(244, 114, 182, 0.1)'] as string[],
  cardSecondary: ['rgba(196, 181, 253, 0.1)', 'rgba(124, 58, 237, 0.05)'] as string[],
  cardGold: ['rgba(251, 191, 36, 0.2)', 'rgba(251, 191, 36, 0.05)'] as string[],

  // ── Tab Bar ──────────────────────────────────
  tabGlow: ['rgba(124, 58, 237, 0.8)', 'rgba(124, 58, 237, 0)'] as string[],

  // ── Generic card background ───────────────────
  card: ['rgba(26, 23, 48, 0.9)', 'rgba(45, 37, 84, 0.6)'] as string[],
};
...
export const LightGradients: Record<string, string[]> = {
  ...
  cosmic: ['#EEF0FA', '#F8F9FF', '#FFFFFF'],
  sunrise: ['#F472B6', '#FBBF24', '#FB923C'],
  ocean: ['#60A5FA', '#7C3AED'],
  forest: ['#34D399', '#059669'],
  lotus: ['#F472B6', '#C4B5FD', '#7C3AED'],
  cardPrimary: ['rgba(124, 58, 237, 0.08)', 'rgba(244, 114, 182, 0.04)'],
  cardSecondary: ['rgba(196, 181, 253, 0.1)', 'rgba(124, 58, 237, 0.03)'],
  cardGold: ['rgba(251, 191, 36, 0.15)', 'rgba(251, 191, 36, 0.03)'],
  tabGlow: ['rgba(124, 58, 237, 0.8)', 'rgba(124, 58, 237, 0)'],
  card: ['rgba(255, 255, 255, 0.9)', 'rgba(238, 240, 250, 0.6)'],
};
